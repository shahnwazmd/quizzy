        ...
        return (() => {
          ...
          class m {
            ...
            notify(t3, e3, n3) {
              ...
              if (s2) if (1 === s2) this.subscriptions[0](t3, e3, n3);
              else for (let i2 = 0; i2 < s2; i2++) {
          ...
          class f {
            ...
            add(t3) {
              if (!this.scheduled.has(t3)) return this.scheduled.add(t3), this.order.push(t3), true;
            }
            remove(t3) {
            ...
            const i2 = { delta: 0, timestamp: 0, isProcessing: false }, o2 = g.reduce((t4, e4) => (t4[e4] = function(t5) {
              ...
              const r3 = /* @__PURE__ */ new WeakSet(), a3 = { schedule: (t6, o4 = false, a4 = false) => {
                ...
                if (i3) o3 = true;
                  ...
                  if (i3 = true, [e5, n4] = [n4, e5], n4.clear(), s3 = e5.order.length, s3) for (let n5 = 0; n5 < s3; n5++) {
          ...
          class T {
            ...
            clearListeners() {
              for (const t3 in this.events) this.events[t3].clear();
            }
            attach(t3, e3) {
          ...
          function nt(t3) {
            ...
            return (t4) => {
              let e4 = i2;
              for (let i3 = 0; i3 < o2; i3++) e4 = i3 < s2 ? e4.replace(K.token, t4[i3]) : i3 < s2 + n3 ? e4.replace(_.token, Z.transform(t4[i3])) : e4.replace(J.token, V(t4[i3]));
              return e4;
            };
          }
          ...
          function bt(t3, e3) {
            ...
            o2 = { ...o2, ...s2 };
            for (const e4 in o2) Pt(t3, e4, (r2 = o2[e4], c(r2) ? r2[r2.length - 1] || 0 : r2));
            var r2;
          }
          function Tt(t3, e3) {
          ...
          function St(t3, e3) {
            if (e3) return (e3[t3] || e3.default || e3).from;
          }
          ...
          function jt(t3) {
            if (t3) return Dt(t3) ? Rt(t3) : Array.isArray(t3) ? t3.map(jt) : Lt[t3];
          }
          const Bt = (t3, e3, n3) => (((1 - 3 * n3 + 3 * e3) * t3 + (3 * n3 - 6 * e3)) * t3 + 3 * e3) * t3;
          function Ft(t3, e3, s2, i2) {
            if (t3 === e3 && s2 === i2) return n2;
          ...
          const re = (t3, e3) => {
            ...
            return (t4) => {
              for (let e4 = 0; e4 < s2; e4++) n3[e4] = i2[e4](t4);
              return n3;
            };
          }, ae = (t3, e3) => {
            const n3 = { ...t3, ...e3 }, s2 = {};
            for (const i2 in n3) void 0 !== t3[i2] && void 0 !== e3[i2] && (s2[i2] = oe(t3[i2], e3[i2]));
            return (t4) => {
              for (const e4 in s2) n3[e4] = s2[e4](t4);
              return n3;
            };
          }, le = (t3, e3) => {
          ...
          function he(t3, e3, { clamp: s2 = true, ease: i2, mixer: o2 } = {}) {
            const a2 = t3.length;
            if (r(a2 === e3.length, "Both input and output ranges must be the same length"), 1 === a2) return () => e3[0];
            ...
            const l2 = function(t4, e4, s3) {
              ...
              let n3 = 0;
              if (u2 > 1) for (; n3 < t3.length - 2 && !(e4 < t3[n3 + 1]); n3++) ;
          ...
          function ve({ keyframes: t3, restDelta: e3, restSpeed: n3, ...s2 }) {
              ...
              if (!ye(t4, ge) && ye(t4, fe)) {
                const n4 = function({ duration: t5 = 800, bounce: e5 = 0.25, velocity: n5 = 0, mass: s3 = 1 }) {
                  ...
                  const l3 = function(t6, e6, n6) {
                    let s4 = n6;
                    for (let n7 = 1; n7 < 12; n7++) s4 -= t6(s4) / e6(s4);
                    return s4;
                  }(i3, r3, 5 / t5);
                  if (t5 = Ct(t5), isNaN(l3)) return { stiffness: 100, damping: 10, duration: t5 };
                  {
            ...
            } else if (1 === f2) x2 = (t4) => r2 - Math.exp(-y2 * t4) * (g2 + (p2 + y2 * g2) * t4);
            else {
          ...
          function be(t3) {
            ...
            for (; !n3.done && e3 < 2e4; ) e3 += 50, n3 = t3.next(e3);
          ...
          const Le = (t3, e3, s2, i2 = {}) => (r2) => {
            ...
            const c2 = function(t4, e4, n3, s3) {
              ...
              let a3;
              const l3 = [];
              for (let t5 = 0; t5 < o2.length; t5++) null === o2[t5] && (o2[t5] = 0 === t5 ? r3 : o2[t5 - 1]), ke(o2[t5]) && l3.push(t5), "string" == typeof o2[t5] && "none" !== o2[t5] && "0" !== o2[t5] && (a3 = o2[t5]);
              if (i3 && l3.length && a3) for (let t5 = 0; t5 < l3.length; t5++) o2[l3[t5]] = mt(e4, a3);
              return o2;
            ...
            }(a2) || (f2 = { ...f2, ...Me(t3, f2) }), f2.duration && (f2.duration = Ct(f2.duration)), f2.repeatDelay && (f2.repeatDelay = Ct(f2.repeatDelay)), !m2 || !p2 || false === a2.type) return function({ keyframes: t4, delay: e4, onUpdate: s3, onComplete: i3 }) {
            ...
            if (e3.owner && e3.owner.current instanceof HTMLElement && !e3.owner.getProps().onUpdate) {
              const s3 = function(t4, e4, { onUpdate: s4, onComplete: i3, ...o2 }) {
                if (!we() || !Ee.has(e4) || o2.repeatDelay || "mirror" === o2.repeatType || 0 === o2.damping || "inertia" === o2.type) return false;
                let r3, a3, l3 = false;
                const u3 = () => {
                  a3 = new Promise((t5) => {
                    r3 = t5;
                ...
                if (((t5, e5) => "spring" === e5.type || "backgroundColor" === t5 || !kt(e5.ease))(e4, o2)) {
                  ...
                  const n3 = [];
                  let s5 = 0;
                  for (; !e5.done && s5 < 2e4; ) e5 = t5.sample(s5), n3.push(e5.value), s5 += 10;
                ...
                return p3.onfinish = () => {
                  ...
                  if (l3 = true, "idle" === p3.playState) return;
          ...
          function Oe(t3, e3, { delay: n3 = 0, transitionOverride: s2, type: i2 } = {}) {
            ...
            for (const e4 in a2) {
              ...
              if (!s3 || void 0 === i3 || c2 && Fe(c2, e4)) continue;
          ...
          function Ne(t3, e3, n3 = {}) {
            ...
            if (t3.notify("AnimationStart", e3), Array.isArray(e3)) {
              ...
              s2 = Promise.all(i2);
            } else if ("string" == typeof e3) s2 = Ie(t3, e3, n3);
            else {
          ...
          for (const t3 in sn) on[t3] = { isEnabled: (e3) => sn[t3].some((t4) => !!e3[t4]) };
          ...
          function un({ preloadedFeatures: e3, createVisualElement: n3, useRender: s2, useVisualState: i2, Component: o2 }) {
            e3 && function(t3) {
              for (const e4 in t3) on[e4] = { ...on[e4], ...t3[e4] };
            }(e3);
          ...
          function hn(t3) {
            ...
            if ("undefined" == typeof Proxy) return e3;
          ...
          function xn(t3, e3, n3, s2) {
            ...
            for (const t4 in e3) {
              ...
              if (Et.has(t4)) {
                if (l2 = true, r2[t4] = h2, !c2) continue;
                n4 !== (s3.default || 0) && (c2 = false);
              } else t4.startsWith("origin") ? (u2 = true, a2[t4] = h2) : i2[t4] = h2;
            }
          ...
          function Pn(t3, e3, n3) {
            for (const s2 in e3) je(e3[s2]) || fn(s2, n3) || (t3[s2] = e3[s2]);
          }
          ...
          function Mn(t3, { attrX: e3, attrY: n3, attrScale: s2, originX: i2, originY: o2, pathLength: r2, pathSpacing: a2 = 1, pathOffset: l2 = 0, ...u2 }, c2, h2, d2) {
            if (xn(t3, u2, c2, d2), h2) return void (t3.style.viewBox && (t3.attrs.viewBox = t3.style.viewBox));
          ...
          function Rn(e3 = false) {
            return (n3, s2, i2, { latestValues: o2 }, r2) => {
              const a2 = (mn(n3) ? kn : bn)(s2, o2, r2, n3), l2 = { ...function(t3, e4, n4) {
                const s3 = {};
                for (const i3 in t3) "values" === i3 && "object" == typeof t3.values || (wn(i3) || true === n4 && Sn(i3) || !e4 && !Sn(i3) || t3.draggable && i3.startsWith("onDrag")) && (s3[i3] = t3[i3]);
                return s3;
          ...
          function Ln(t3, { style: e3, vars: n3 }, s2, i2) {
            ...
            for (const e4 in n3) t3.style.setProperty(e4, n3[e4]);
          }
          ...
          function Bn(t3, e3, n3, s2) {
            Ln(t3, e3, void 0, s2);
            for (const n4 in e3.attrs) t3.setAttribute(jn.has(n4) ? n4 : At(n4), e3.attrs[n4]);
          }
          function Fn(t3, e3) {
            const { style: n3 } = t3, s2 = {};
            for (const i2 in n3) (je(n3[i2]) || e3.style && je(e3.style[i2]) || fn(i2, t3)) && (s2[i2] = n3[i2]);
            return s2;
          }
          function On(t3, e3) {
            const n3 = Fn(t3, e3);
            for (const s2 in t3) (je(t3[s2]) || je(e3[s2])) && (n3[-1 !== wt.indexOf(s2) ? "attr" + s2.charAt(0).toUpperCase() + s2.substring(1) : s2] = t3[s2]);
            return n3;
          }
          function In(t3) {
          ...
          function Nn(t3, e3, n3, s2) {
            const i2 = {}, o2 = s2(t3, {});
            for (const t4 in o2) i2[t4] = In(o2[t4]);
            ...
            return h2 && "boolean" != typeof h2 && !_e(h2) && (Array.isArray(h2) ? h2 : [h2]).forEach((e4) => {
              ...
              for (const t4 in s3) i2[t4] = s3[t4];
            }), i2;
          }
          ...
          const rs = { some: 0, all: 1 }, as = { inView: { Feature: class extends Jn {
            ...
            startObserver() {
              ...
              return function(t4, e4, n4) {
                ...
                if (this.isInView === e4) return;
                if (this.isInView = e4, i2 && !e4 && this.hasEnteredView) return;
          ...
          function ls(t3, e3) {
            ...
            for (let s2 = 0; s2 < n3; s2++) if (e3[s2] !== t3[s2]) return false;
            return true;
          }
          ...
          const ms = { animation: { Feature: class extends Jn {
              ...
              super(t3), t3.animationState || (t3.animationState = function(t4) {
                ...
                function o2(o3, r2) {
                  ...
                  for (let e4 = 0; e4 < cs; e4++) {
                    ...
                    if (b2 && s2 && t4.manuallyAnimateOnMount && (b2 = false), y2.protectedKeys = { ...d2 }, !y2.isActive && null === P2 || !v2 && !y2.prevProp || _e(v2) || "boolean" == typeof v2) continue;
            ...
            update() {
              ...
              if (!this.node.animationState || t3 === s2) return;
          ...
          function bs(t3, e3) {
            if (t3.length < 2) return { x: 0, y: 0 };
            let n3 = t3.length - 1, s2 = null;
            const i2 = Ps(t3);
            for (; n3 >= 0 && (s2 = t3[n3], !(i2.timestamp - s2.timestamp > Ct(e3))); ) n3--;
            if (!s2) return { x: 0, y: 0 };
          ...
          class Qs {
            ...
            start(t3, { snapToCursor: e3 = false } = {}) {
              ...
              n3 && false === n3.isPresent || (this.panSession = new fs(t3, { onSessionStart: (t4) => {
                ...
                if (n4 && !s2 && (this.openGlobalLock && this.openGlobalLock(), this.openGlobalLock = Kn(n4), !this.openGlobalLock)) return;
                ...
                if (!n4 && !this.openGlobalLock) return;
                const { offset: r2 } = e4;
                if (s2 && null === this.currentDirection) return this.currentDirection = function(t5, e5 = 10) {
                  let n5 = null;
            ...
            updateAxis(t3, e3, n3) {
              ...
              if (!n3 || !ti(t3, s2, this.currentDirection)) return;
            ...
            startAnimation(t3) {
              const { drag: e3, dragMomentum: n3, dragElastic: s2, dragTransition: i2, dragSnapToOrigin: o2, onDragTransitionEnd: r2 } = this.getProps(), a2 = this.constraints || {}, l2 = js((r3) => {
                if (!ti(r3, e3, this.currentDirection)) return;
                let l3 = a2 && a2[r3] || {};
                o2 && (l3 = { min: 0, max: 0 });
            ...
            snapToCursor(t3) {
              js((e3) => {
                ...
                if (!ti(e3, n3, this.currentDirection)) return;
            ...
            scalePositionWithinConstraints() {
              ...
              if (!Ze(e3) || !n3 || !this.constraints) return;
              this.stopAnimation();
              const s2 = { x: 0, y: 0 };
              js((t4) => {
          ...
          function Pi(t3, e3, [n3, s2, i2], o2, r2) {
            !function(t4, e4 = 0, n4 = 1, s3 = 0.5, i3, o3 = t4, r3 = t4) {
              if (H.test(e4) && (e4 = parseFloat(e4), e4 = Kt(r3.min, r3.max, e4 / 100) - r3.min), "number" != typeof e4) return;
          ...
          function Bi({ attachResizeListener: t3, defaultParent: e3, measureScroll: n3, checkIsScrollRoot: s2, resetTransform: i2 }) {
            return class {
              constructor(t4 = {}, n4 = null == e3 ? void 0 : e3()) {
                ...
                for (let t5 = 0; t5 < this.path.length; t5++) this.path[t5].shouldResetTransform = true;
              ...
              mount(e4, n4 = this.root.hasTreeAnimated) {
                ...
                i3 && this.root.registerSharedNode(i3, this), false !== this.options.animate && r2 && (i3 || o2) && this.addEventListener("didUpdate", ({ delta: t4, hasLayoutChanged: e5, hasRelativeTargetChanged: n5, layout: s4 }) => {
                  ...
                  } else e5 || zi(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
              ...
              update() {
                if (this.updateScheduled = false, this.isUpdateBlocked()) return this.unblockUpdate(), this.clearAllSnapshots(), void this.nodes.forEach($i);
              ...
              updateLayout() {
                ...
                if (this.resumeFrom && !this.resumeFrom.instance) for (let t5 = 0; t5 < this.path.length; t5++) this.path[t5].updateScroll();
              ...
              measurePageBox() {
                const { visualElement: t4 } = this.options;
                if (!t4) return { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } };
              ...
              removeTransform(t4) {
                ...
                for (let t5 = 0; t5 < this.path.length; t5++) {
                  ...
                  if (!n4.instance) continue;
                  if (!Is(n4.latestValues)) continue;
              ...
              resolveTargetDelta(t4 = false) {
                ...
                if (!(t4 || s3 && this.isSharedProjectionDirty || this.isProjectionDirty || (null === (e4 = this.parent) || void 0 === e4 ? void 0 : e4.isProjectionDirty) || this.attemptToResolveRelativeTarget)) return;
              ...
              calcProjection() {
                ...
                let s3 = true;
                if ((this.isProjectionDirty || (null === (t4 = this.parent) || void 0 === t4 ? void 0 : t4.isProjectionDirty)) && (s3 = false), n4 && (this.isSharedProjectionDirty || this.isTransformDirty) && (s3 = false), this.resolvedRelativeTargetAt === x.timestamp && (s3 = false), s3) return;
                const { layout: i3, layoutId: o2 } = this.options;
                ...
                const { target: l2 } = e4;
                if (!l2) return void (this.projectionTransform && (this.projectionDelta = { x: { translate: 0, scale: 1, origin: 0, originPoint: 0 }, y: { translate: 0, scale: 1, origin: 0, originPoint: 0 } }, this.projectionTransform = "none", this.scheduleRender()));
              ...
              getStack() {
                ...
                if (t4) return this.root.sharedNodes.get(t4);
              }
              ...
              resetRotation() {
                ...
                if ((n4.rotate || n4.rotateX || n4.rotateY || n4.rotateZ) && (e4 = true), !e4) return;
                const s3 = {};
                ...
                t4.render();
                for (const e5 in s3) t4.setStaticValue(e5, s3[e5]);
                t4.scheduleRender();
              }
              getProjectionStyles(t4 = {}) {
                var e4, n4;
                const s3 = {};
                if (!this.instance || this.isSVG) return s3;
                if (!this.isVisible) return { visibility: "hidden" };
                s3.visibility = "";
                const i3 = this.getTransformTemplate();
                if (this.needsReset) return this.needsReset = false, s3.opacity = "", s3.pointerEvents = In(t4.pointerEvents) || "", s3.transform = i3 ? i3(this.latestValues, "") : "none", s3;
          ...
          const uo = /* @__PURE__ */ new Set(["width", "height", "top", "left", "right", "bottom", "x", "y", "translateX", "translateY"]), co = (t3) => uo.has(t3), ho = (t3) => t3 === L || t3 === z, mo = (t3, e3) => parseFloat(t3.split(", ")[e3]), po = (t3, e3) => (n3, { transform: s2 }) => {
            if ("none" === s2 || !s2) return 0;
            const i2 = s2.match(/^matrix3d\((.+)\)$/);
            if (i2) return mo(i2[1], e3);
            {
            ...
            return ((t4) => Object.keys(t4).some(co))(e3) ? ((t4, e4, n4 = {}, s3 = {}) => {
              ...
              if (i2.forEach((i3) => {
                ...
                if (c(m2)) {
                  ...
                  h2 = m2[e5], d2 = gt(h2);
                  for (let n5 = e5; n5 < t5 && null !== m2[n5]; n5++) p2 ? r(gt(m2[n5]) === p2, "All keyframes must be of the same type") : (p2 = gt(m2[n5]), r(p2 === d2 || ho(d2) && ho(p2), "Keyframes must be of the same dimension as the current value"));
                } else p2 = gt(m2);
                if (d2 !== p2) if (ho(d2) && ho(p2)) {
                  const t5 = u2.get();
                  "string" == typeof t5 && u2.set(parseFloat(t5)), "string" == typeof m2 ? e4[i3] = parseFloat(m2) : Array.isArray(m2) && p2 === z && (e4[i3] = m2.map(parseFloat));
                } else (null == d2 ? void 0 : d2.transform) && (null == p2 ? void 0 : p2.transform) && (0 === h2 || 0 === m2) ? 0 === h2 ? u2.set(p2.transform(h2)) : e4[i3] = d2.transform(m2) : (a2 || (o2 = function(t5) {
                  const e5 = [];
          ...
          class Ao extends class {
            ...
            unmount() {
              ...
              for (const t3 in this.events) this.events[t3].clear();
              for (const t3 in this.features) this.features[t3].unmount();
              this.current = null;
            }
            ...
            update(t3, e3) {
              ...
              this.prevMotionValues = function(t4, e4, n3) {
                ...
                for (const i2 in e4) {
                  ...
                  if (je(o2)) t4.addValue(i2, o2), Be(s2) && s2.add(i2);
                  else if (je(r2)) t4.addValue(i2, S(o2, { owner: t4 })), Be(s2) && s2.remove(i2);
                  else if (r2 !== o2) if (t4.hasValue(i2)) {
                ...
                for (const s3 in n3) void 0 === e4[s3] && t4.removeValue(s3);
                return e4;
            ...
            getVariantContext(t3 = false) {
              if (t3) return this.parent ? this.parent.getVariantContext() : void 0;
            ...
            addVariantChild(t3) {
              ...
              if (e3) return e3.variantChildren && e3.variantChildren.add(t3), () => e3.variantChildren.delete(t3);
            }
            addValue(t3, e3) {
            ...
            getValue(t3, e3) {
              if (this.props.values && this.props.values[t3]) return this.props.values[t3];
              ...
              if (s2 && (e3 && (e3 = s2(e3)), n3 && (n3 = s2(n3)), o2 && (o2 = s2(o2))), i2) {
                ...
                const t4 = ((t5, e4, n4, s3) => {
                  const i3 = function(t6, { ...e5 }, n5) {
                    const s4 = t6.current;
                    if (!(s4 instanceof Element)) return { target: e5, transitionEnd: n5 };
